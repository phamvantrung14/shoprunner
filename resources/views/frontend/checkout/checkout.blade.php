        ...
        <div class="container-fluid">
            ...
            @else
                <div class="container">
                    <div class="row">
                    <div class="row">
                        <p  class="btn btn-secondary"  id="ship_home" style="margin-right: 15px;display: none">Cash Payment</p>
                        <p class="btn btn-success" id="tt_online" style="">Online Payment</p>
{{--                        <a class="btn btn-danger" href="{{route("get.checkout.pay")}}" style="">Online Payment</a>--}}
                    </div>
                    </div>
                </div>
            <div class="checkout-area area1">
                <div class="row">
                            ...
                            <div class="col-lg-6 offset-xl-1 col-xl-5 col-sm-12">
                                ...
                                @endif
                                    ...
                                    <div class="checkbox-form">
                                        <h3 class="shoping-checkboxt-title">Cash Payment</h3>
                                        <div class="row">
                                            <div class="col-lg-12">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="single-form-row">
                                                    ...
                                                    <select id="area_id" name="area_id" style="width: 100%;height: 42px;border: 1px solid #e5e5e5;padding: 0 0 0 10px;">
                                            ...
                                            <div class="col-lg-12">
                                                <p class="single-form-row">
                                                    ...
                                                    <select id="city_id" name="city_id" style="width: 100%;height: 42px;border: 1px solid #e5e5e5;padding: 0 0 0 10px;">
                                            ...
                                            <div class="col-lg-12">
                                                <div class="single-form-row ">
                                                    <label>
                                                        <input type="hidden" name="payment"  value="2">Payments<span class="required">*</span></label><br>
...
@section("script")
    <script>
        $(document).ready(function () {
            ...
            $("#ship_home").click(function (event) {
                $("#tt_online").css("display","block");
                $(this).css("display","none");
                $(".area2 .row").addClass("an");
                $(".area1 .row").removeClass("an");

            });
            $("#tt_online").click(function (event) {
                $("#ship_home").css("display","block");
                $(this).css("display","none");
                $(".area1 .row").addClass("an");
                $(".area2 .row").removeClass("an");
            })
